...
SECRET_KEY = 'django-insecure-)lxo=ya0_u6eh*d@f+ru-5*o2gvf8oretxnf-k-=+iy@*jrzm-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['.vercel.app', '.now.sh', '187.0.0.1', 'localhost', '127.0.0.1']
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "restaurant_app/static")
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'restaurantelocator@gmail.com'
EMAIL_HOST_PASSWORD = 'niaw ovot jdcp atwc'
